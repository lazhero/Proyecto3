...
def ventana_about():#funcion para la info
    ...
    textoE="""
        ...
        Descripcion del programa:El programa se trata de una interfaz
        para el control de un auto a control remoto desarrollado en Arduino
        Entradas:El programa recibe entradas desde el teclado para realizar
        diferentes acciones
        . W para avanzar ,S para retroceder, a para direccionales izquierda,
        d para direccionales derechas,i para infinito,N para orientarse
        hacia el norte 
